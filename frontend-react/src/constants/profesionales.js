...
export const profesionales = [
  {
    ...
    reviews: [
      {
        text: '"Marcela es increíble. Después de mi operación de hombro pensé que no iba a recuperar el movimiento completo. En 3 meses me devolvió la vida."',
        author: '— Rodrigo M., 42 años',
      },
      {
        text: '"Muy profesional, explica todo con paciencia y claridad. Se nota que ama lo que hace."',
        author: '— Claudia F., 55 años',
      },
    ],
  },
  {
    ...
    reviews: [
      {
        text: '"Me rompí los ligamentos y en 5 meses volví a correr. Julián es un crack, sabe exactamente qué hacer en cada etapa."',
        author: '— Tomás G., 28 años',
      },
      {
        text: '"Muy detallista, siempre está al tanto de las últimas técnicas. Mejoré muchísimo."',
  ...
  },
  {
    ...
    reviews: [
      {
        text: '"Tenía una hernia de disco que me limitaba completamente. Andrea me enseñó a moverme diferente y el dolor desapareció."',
        author: '— Néstor V., 48 años',
      },
      {
        text: '"Manos de oro, literalmente. Salgo de cada sesión como nueva persona."',
        author: '— Daniela K., 37 años',
      },
    ],
  },
  {
    ...
    reviews: [
      {
        text: '"Lucas me ayudó a entender mi cuerpo. Nunca había prestado atención a mi postura y ahora tengo cero dolores."',
        author: '— Valeria O., 44 años',
      },
      {
        text: '"Las sesiones de Pilates son muy completas y bien explicadas. Muy recomendable."',
        author: '— Marcos H., 52 años',
      },
    ],
  },
  {
    ...
    reviews: [
      {
        text: '"Tenía epicondilitis desde hace años. Carolina es la primera profesional que realmente me alivió el dolor con el láser."',
        author: '— Alberto R., 60 años',
      },
      {
        text: '"Puntual, amable y muy eficiente. El tratamiento con ultrasonido fue clave en mi recuperación."',
        author: '— Patricia N., 39 años',
      },
    ],
  },
  {
    ...
    reviews: [
      {
        text: '"Mi papá tuvo un ACV y gracias a Emilio recuperó la movilidad del lado derecho. Es un profesional extraordinario."',
        author: '— Florencia T., 45 años',
      },
      {
        text: '"Paciencia infinita y un método muy sólido. Lo recomiendo con los ojos cerrados."',
        author: '— Ernesto C., 67 años',
      },
    ],
  },
]
