  ...
  return (
    <>
      ...
      <div className='page-hero'>
        ...
        <h1>
          Rehabilitación <span>integral</span>
          <br />
          para cada zona del cuerpo
        </h1>
        <p>
          Combinamos evidencia científica, tecnología de vanguardia y terapia manual para lograr tu
          ...
          ({
            ...
            <div className='zone-section' id={`zona-${id}`} ref={sectionRefs[id]} key={id}>
              ...
              <div className='patologias-row'>
                <div className='card-inner-title'>
                  <span />
                  Patologías frecuentes que tratamos
                </div>
                <div className='patologias-tags'>
                  {pathologies.map((p) => (
                    <span className='pat-tag' key={p}>
                      {p}
                    </span>
                  ))}
                </div>
