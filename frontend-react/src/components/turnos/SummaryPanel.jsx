...
function IconZona() {
  return (
    <svg className="summary-v2-row-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round">
...
export function SummaryPanel({ zona, shifts, medioPago, onConfirm, confirmando ,precioTurno}) {
  ...
  return (
    <div className="summary-v2">
      ...
      <div className="summary-v2-columns">
        ...
        <div className="summary-v2-table">
          ...
          <div className="summary-v2-total">
            ...
            <div className="summary-v2-total-value">
              {fmt(total)}
              {discountPct > 0 && (
                <span className="summary-v2-original">{fmt(subtotal)}</span>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="summary-v2-info">
          <div className="summary-v2-info-card summary-v2-info-card--highlight">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" strokeWidth="1.8" strokeLinecap="round" style={{ flexShrink: 0 }}>
          ...
          <div className="summary-v2-info-card">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--text-muted)" strokeWidth="1.8" strokeLinecap="round" style={{ flexShrink: 0 }}>
              <circle cx="12" cy="12" r="10"/>
              <path d="M12 6v6l4 2"/>
            </svg>
            <div>
      ...
      <p className="summary-v2-redirect">
        Serás redirigido al medio de pago seleccionado
      </p>
